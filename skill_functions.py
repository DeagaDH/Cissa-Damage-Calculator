...
full_dict = {'Airborne':Airborne,
            ...
            '(True) Crit. Elem. ':Critical_Element,
            '(True) D. Awaken. ':Dragonvein_Awakening,
            'Elemental Attack':Elemental_Attack,
            '(True) Elem. Accel. ':Elemental_Acceleration,
            'Fortify':Fortify,
            'Frostcraft':Frostcraft,
            '(Felyne) Heroics':Heroics,
            'Latent Power':Latent_Power,
            'Maximum Might':Maximum_Might,
            'Non-Elemental Boost':Non_Elemental_Boost,
            'Normal/Pierce Shots':NormalPierce_Shots,
            ...
            'Spread/Power Shots':SpreadPower_Shots,
            'Weakness Exploit':Weakness_Exploit,
            'Demondrug':Demondrug,
            'Demon Power':Demon_Powder,
            'Evasion Mantle':Evasion_Mantle,
            'Might Seed/Pill':Might_Seed,
            'Powercharm/talon':Powercharm,
            'Powercone':Powercone,
            'Canteen Atk Up':CanteenAttack,
            'Felyne Bombardier':Felyne_Bombardier,
            'Felyne Booster':Felyne_Booster,
            'Felyne Temper':Felyne_Temper,
            'Felyne Sharpshooter':Felyne_Sharpshooter,
            'Attack Up':Melodies_Attack,
            'Elem. Atk and Effect.':Melodies_Elemental}
